...
<body>
<nav class="navbar navbar-light bg-light" style="background-color: #fefefe;">
    <a class="navbar-brand" href="index.php">
        <img src="assets/img/logo.png" width="100" height="100" alt="Catarsis">
    </a>
    ...
    if (empty($_SESSION['email'])) {
        echo '<div class="text-right">
                ...
                <span>
                <a href="templates/registrationPage.php">
        ...
        echo '<div class="text-right">
                ...
                <span>
                <a href="templates/profile.php?id=' . $_SESSION['id'] . '">
                    <button type="button" class="btn btn-info nav-button">
